...
// 定义函数指针类型
#ifdef _WIN32
    typedef void (__cdecl* FUNC_ADDR)( void * );
#else
...
public:
    ...
    /** 功能：读二进制文件 */
    static bool ReadBinFile(char* pcContent, unsigned long & dwReadLen, const char *pcFileName);

    /** 功能：写二进制文件 */
    static bool WriteBinFile(char* pcContent, unsigned long dwWriteLen, const char *pcFileName);
